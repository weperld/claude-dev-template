...
| 명령어 | 용도 |
|--------|------|
| `/project:신규 [--lite\|--standard\|--full]` | 새 기능 추가 (프로젝트 파이프라인, 오버라이드 가능) |
| `/project:수정 [--lite\|--standard\|--full]` | 버그 수정 또는 기능 개선 (프로젝트 파이프라인, 오버라이드 가능) |
...
- **수렴 검증**: 계획/설계 단계에서 사용자 확인을 거쳐 필수 보완 사항 0건까지 반복 점검
